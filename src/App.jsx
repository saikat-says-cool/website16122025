        ...
        `}
            ...
            <div className="relative z-10">
                ...
                <section className="py-32 px-6 border-t border-white/5 bg-black/40 relative">
                    <div className="w-full mx-auto px-4 md:px-6">
                        <span className="text-xs tracking-[0.2em] text-gray-500 font-bold mb-12 block uppercase text-center">The Verdict</span>

                        <div className="grid md:grid-cols-2 gap-8">
                            {/* Testimonial 1 */}
                            <div className="p-10 rounded-[2.5rem] bg-white/[0.02] border border-white/5 backdrop-blur-md hover:border-white/10 transition-all duration-500 group">
                                <div className="mb-8">
                                    <div className="flex gap-1 mb-4">
                                        {[1, 2, 3, 4, 5].map((i) => (
                                            <svg key={i} className="w-4 h-4 text-white/40 group-hover:text-white/80 transition-colors" fill="currentColor" viewBox="0 0 20 20">
                                    ...
                                    <p className="text-xl text-gray-300 leading-relaxed font-light italic">
                                        "We were stuck in the referral loop for years. Every agency we talked to promised 'leads' but delivered spam that made us look like amateurs. Artificialyze was different. They didn't just send emails; they built a technical infrastructure that protected our reputation while booking us into rooms with Fortune 500 CISOs."
                                    </p>
                                </div>
                                <div className="flex items-center gap-4">
                                    <div className="w-12 h-12 rounded-full bg-gradient-to-br from-gray-700 to-gray-900 border border-white/10 flex items-center justify-center text-white font-bold">MT</div>
                                    <div>
                                        <div className="text-white font-bold">Marcus Thorne</div>
                                        <div className="text-xs text-gray-500 uppercase tracking-wider">Founder & CEO, Thorne Security</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="p-10 rounded-[2.5rem] bg-white/[0.02] border border-white/5 backdrop-blur-md hover:border-white/10 transition-all duration-500 group">
                                <div className="mb-8">
                                    ...
                                    <p className="text-xl text-gray-300 leading-relaxed font-light italic">
                                        "The hardest part of cybersecurity sales is the 'BS detector' of the CISO. If your first touchpoint sounds like marketing, you're dead. These guys write like engineers. They understood our pentesting stack better than our own sales team did. We saw a 7% reply rate in month two."
                                    </p>
                                </div>
                                <div className="flex items-center gap-4">
                                    <div className="w-12 h-12 rounded-full bg-gradient-to-br from-gray-700 to-gray-900 border border-white/10 flex items-center justify-center text-white font-bold">DB</div>
                                    <div>
                                        <div className="text-white font-bold">Dan Bilzerian</div>
                                        <div className="text-xs text-gray-500 uppercase tracking-wider">Head of Growth, Nexus Defense</div>
                                    </div>
                                </div>
                            </div>
                        </div>
